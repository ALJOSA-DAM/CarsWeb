...
<section></section>
    <div class="body">
            ...
            <div class="formulario">
                    ...
                    <div class="form">
                        <input type="text" name="user" placeholder="Nombre" class="form-input"><br/>
<!--                        <input type="password" name="password" placeholder="Contraseña" class="form-input"><br/>-->
                        ...
                        <input type="text" name="descripcion" placeholder="Escriba aquí su consulta" class="form-input-area"><br/>
